...
> 不知不觉，踩坑前端也两年多了。这一路的学习经历，也慢慢发现虽然技术会不断更新，但很多优秀的思想却会被一代一代传承，很多时候，当你掌握了这种思想，其实对于相似的技术也就融会贯通了。记得初学react时，坎坎坷坷，可当从react切到vue时，发现也不过如此，都是以数据驱动页面更新的思想去编写代码，只是两者会有各自的条条框框去限制你该如何更新。
> 
> 2019年8月份的时候就计划学习《大话设计模式》，无奈执行力如此之低，疫情期间在家颓废了也将近3周，总觉得这样混日子内心不安，于是又重启这个学习计划，亡羊补牢，为时不晚。
