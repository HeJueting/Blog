...
![image](http://qiniu.hejueting.cn/github/notes/colorCompare.png)
...
![image](http://qiniu.hejueting.cn/github/notes/transformation.png)

LSB隐写就是修改RGB颜色分量种最低二进制位，也就是最低有效位（LSB），而人类的眼睫不会注意到这细小的变化。

![image](http://qiniu.hejueting.cn/github/notes/change.png)
...
![image](http://qiniu.hejueting.cn/github/notes/imageData.png)
...
![image](http://qiniu.hejueting.cn/github/notes/example.png)
...
![image](http://qiniu.hejueting.cn/github/notes/result.png)
